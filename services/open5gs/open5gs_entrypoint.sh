...
export NGAP_BIND_ADDR="${NGAP_BIND_ADDR:-$OPEN5GS_IP}"
export AMF_LOG_LEVEL="${AMF_LOG_LEVEL:-info}"
...
# Start additional iperf3 servers on ports 5000-5003
echo "Starting additional iperf3 servers on ports 5000-5003..."
iperf3 -s -p 5000 -D
iperf3 -s -p 5001 -D
iperf3 -s -p 5002 -D
iperf3 -s -p 5003 -D
