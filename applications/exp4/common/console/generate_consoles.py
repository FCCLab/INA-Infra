        ...
        <div class="console" style="border:1px solid var(--border);border-radius:10px">
          ...
          <div class="iperf-ctl">
            ...
            <label class="iperf-args-label">arguments
              <input id="iperf-args" type="text" spellcheck="false" autocomplete="off" placeholder="-c HOST -p 5201 -R -P 2 -b 1M -t 0 -i 1 --forceflush -u" onkeydown="if(event.key==='Enter'){event.preventDefault();iperfAct('start');}"/>
            </label>
          </div>
