#!/usr/bin/env python3
"""Exp4 S4 UE backend: SFTP of encrypted 1 MB files + controllable iperf3 DL.

List the server queue every 1s and download every file that is not already in
flight. Application latency is generate+encrypt+enqueue time from the filename; E2E is
...
SERVER = os.environ.get("TARGET_SERVER_IP") or os.environ.get("SFTP_HOST") or "10.1.137.214"
