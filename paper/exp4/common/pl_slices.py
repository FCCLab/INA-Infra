"""Shared five-slice DL catalog and S1–S3 PL placement (co-located sites)."""
...
# S1/S2/S3: PL co-located CU-UP / UPF / APP
PL_SLICES = {
    1: {
        "name": "FTP",
        "label": "FTP 5 MB",
...
# S0 anti-pattern: UPF/CU at central, APP at edge
S0_SLICES = {
    sid: {**row, "cu": "central", "upf": "central", "app": "edge"}
    for sid, row in PL_SLICES.items()
}
