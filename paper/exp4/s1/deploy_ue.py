#!/usr/bin/env python3
"""Bring up DL UEs + app clients on edge `usrp` for Exp4 S1 (exp4-s1).

Examples:
  python3 paper/exp4/s1/deploy_ue.py
  python3 paper/exp4/s1/deploy_ue.py --ue 5
  python3 paper/exp4/s1/deploy_ue.py 1,2,3,4
  python3 paper/exp4/s1/deploy_ue.py --undeploy --ue 1,2,3,4
"""
...
def main(argv: list[str] | None = None) -> None:
    ...
    combined = out_dir / "exp4_s1_ues.yaml"
