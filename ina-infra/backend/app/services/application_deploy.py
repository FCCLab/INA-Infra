...
def _influx_pusher_container(
    ...
    pusher_code = (
        ...
        "          except Exception:\n"
        "            pass\n"
        "      if 'slicea_e2e_delay_seconds_sum' in fields and 'slicea_e2e_delay_seconds_count' in fields:\n"
        "        c = fields['slicea_e2e_delay_seconds_count']\n"
        "        if c > 0: fields['e2e_delay_ms'] = round((fields['slicea_e2e_delay_seconds_sum'] / c) * 1000.0, 2)\n"
        "      if 'slicea_net_delay_seconds_sum' in fields and 'slicea_net_delay_seconds_count' in fields:\n"
        "        c = fields['slicea_net_delay_seconds_count']\n"
        "        if c > 0: fields['net_delay_ms'] = round((fields['slicea_net_delay_seconds_sum'] / c) * 1000.0, 2)\n"
        "      if 'slicea_yolo_delay_seconds_sum' in fields and 'slicea_yolo_delay_seconds_count' in fields:\n"
        "        c = fields['slicea_yolo_delay_seconds_count']\n"
        "        if c > 0: fields['yolo_delay_ms'] = round((fields['slicea_yolo_delay_seconds_sum'] / c) * 1000.0, 2)\n"
        "    except Exception:\n"
        "      pass\n"
        "    if fields:\n"
