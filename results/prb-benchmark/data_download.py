...
PRB max% sweep (near-RT RIC). Reads measure windows from ``timestamp.csv``
and writes under ``data/`` (gitignored):

  data/step_01_5pct.npz  # t_unix_s, client_mbps, server_mbps, …
