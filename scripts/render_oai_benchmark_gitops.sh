...
OAI_IMAGE_TAG="${OAI_IMAGE_TAG:-nws-v0.8.4-amd64}"
# Softmodem bump (UL NS total_prbs=BWP) is in cucp/du only; keep others on 0.8.2
# until a full release rebuild tags them together.
OAI_SOFTMODEM_IMAGE_TAG="${OAI_SOFTMODEM_IMAGE_TAG:-${OAI_IMAGE_TAG}}"
OAI_OTHER_IMAGE_TAG="${OAI_OTHER_IMAGE_TAG:-nws-v0.8.2-amd64}"
OAI_SIDECAR_IMAGE_TAG="${OAI_SIDECAR_IMAGE_TAG:-nws-v0.5-amd64}"
OAI_CUCP_IMAGE="${OAI_CUCP_IMAGE:-${OAI_REGISTRY}/oai-cucp:${OAI_SOFTMODEM_IMAGE_TAG}}"
OAI_DU_IMAGE="${OAI_DU_IMAGE:-${OAI_REGISTRY}/oai-du:${OAI_SOFTMODEM_IMAGE_TAG}}"
OAI_CUUP_IMAGE="${OAI_CUUP_IMAGE:-${OAI_REGISTRY}/oai-nr-cuup:${OAI_OTHER_IMAGE_TAG}}"
OAI_NR_UE_IMAGE="${OAI_NR_UE_IMAGE:-${OAI_REGISTRY}/oai-nr-ue:${OAI_SOFTMODEM_IMAGE_TAG}}"
OAI_FLEXRIC_IMAGE="${OAI_FLEXRIC_IMAGE:-${OAI_REGISTRY}/oai-flexric:${OAI_OTHER_IMAGE_TAG}}"
OAI_XAPP_IMAGE="${OAI_XAPP_IMAGE:-${OAI_REGISTRY}/nws-xapp:nws-v0.6-amd64}"
OAI_RAN_OPERATOR_IMAGE="${OAI_RAN_OPERATOR_IMAGE:-${OAI_REGISTRY}/oai-ran-controller:cpuagent-v10}"
IPERF3_N6_IMAGE="${IPERF3_N6_IMAGE:-${OAI_REGISTRY}/iperf3-n6:ws-ctrl-7}"
